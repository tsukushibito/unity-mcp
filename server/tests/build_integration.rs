...
async fn test_build_player_integration() -> anyhow::Result<()> {
    ...
    println!(
        "Build result: status_code={}, message={}",
...
async fn test_build_asset_bundles_integration() -> anyhow::Result<()> {
    ...
    let result = build_tool
        .build_asset_bundles_default("AssetBundles/Test".to_string())
        .await?;

    println!(
        "AssetBundles build result: status_code={}, message={}",
        result.status_code, result.message
    );
...
async fn test_build_android_integration() -> anyhow::Result<()> {
    ...
    println!(
        "Android build result: status_code={}, message={}",
        result.status_code, result.message
    );
    println!("Output path: {}", result.output_path);
...
async fn test_build_macos_integration() -> anyhow::Result<()> {
    ...
    println!(
        "macOS build result: status_code={}, message={}",
        result.status_code, result.message
    );
    println!("Output path: {}", result.output_path);
